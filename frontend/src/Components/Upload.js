...
function Upload() {
    ...
    const handleTextChange = (name) => (e) => {
        ...
        } else if (name === 'type') { // Fixed: Set type state properly
    ...
    const handleUpload = async (e) => {
        ...
        if (title) {
            ...
            formData.append('title', title); // Use state directly
            formData.append('description', description); // Use state directly
            formData.append('type', type); // Use state directly
            ...
            <form onSubmit={handleUpload} action="api/upload" method="POST" encType="multipart/form-data">
                ...
                <div className="input-control">
                    ...
                    <input
                        type="text"
                        name="type"
                        placeholder="Enter Type of the Clip..."
                        id="type"
                        value={type}
